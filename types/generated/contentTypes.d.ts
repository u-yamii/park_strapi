...
export interface ApiParkPark extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    locale_detail: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::park.park'> &
      Schema.Attribute.Private;
    lon: Schema.Attribute.Decimal;
    number: Schema.Attribute.Integer;
    park_hazard_levels: Schema.Attribute.Relation<
      'oneToMany',
      'api::parks-hazard-level.parks-hazard-level'
    >;
    park_name: Schema.Attribute.String;
    park_name_kana: Schema.Attribute.String;
    park_type: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiParksHazardLevelParksHazardLevel
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    park: Schema.Attribute.Relation<'manyToOne', 'api::park.park'>;
    park_name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usability: Schema.Attribute.String;
  };
}
